...
if record is True:
    ...
    record = open("/home/letrend/workspace/roboy_middleware/data0.log","w")
    ...
    def __init__(self):
        ...
        if train:
            ...
            if record is False:
                ...
                dataset = pandas.read_csv("/home/letrend/workspace/roboy_middleware/data0.log", delim_whitespace=True, header=1)
