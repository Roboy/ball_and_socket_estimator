...
class ball_in_socket_estimator:
    ...
    def magneticsCallback(self, data):
        ...
        with self.graph.as_default(): # we need this otherwise the precition does not work ros callback
            ...
            rospy.loginfo_throttle(1, (euler[0],euler[1],euler[2]))
            ...
            # self.msg.position = [0.9*self.msg.position[0]+0.1*euler[0], 0.9*self.msg.position[1]+0.1*euler[1], 0.9*self.msg.position[2]+0.1*euler[2]]
